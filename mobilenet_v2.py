...
def inference(images, num_classes=None, keep_probability=1.0, phase_train=False,
    ...
    with slim.arg_scope(arg_scope):
        return mobilenet_v2(images, num_classes=num_classes, dropout_keep_prob=keep_probability, is_training=phase_train, reuse=reuse)
